...
EOF
    ...
    /usr/bin/mongod --port 27017 --bind_ip_all --replSet rs0 --journal --dbpath /data/db --keyFile /keys/mongoKeyFile.key --ssl --sslMode requireSSL --sslPEMKeyFile /etc/ssl/mongodb.pem --sslCAFile /etc/ssl/ca.pem
